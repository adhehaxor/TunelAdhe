...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " Dev > AdheVPN ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e " Auther : ${green}ADHEVPN ${NC}"
echo -e " © Recode By My Self Adhe•VPN ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/adhehaxor/TunelAdhe/GM/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/adhehaxor/TunelAdhe/GM/Register"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="6253227559"
KEY="6560499595:AAGyfbbY0GZ-S9glAbMdjMz-W5QqRWajVHA"
...
wget -q https://raw.githubusercontent.com/adhehaxor/TunelAdhe/GM/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
